...
class CustomSpecialOfferAdapter(context: Context, listProducts:ArrayList<ItemProduct>): RecyclerView.Adapter<CustomSpecialOfferAdapter.MyView>(){
    var context = context
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyView {
        var itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_product, parent, false)
